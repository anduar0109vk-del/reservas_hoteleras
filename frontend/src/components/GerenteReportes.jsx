// src/components/GerenteReportes.jsx
  ...
  const cargarDatos = async () => {
    try {
      ...
      setEstadisticas({
        ...
        ingresosTotales: data.reduce((total, r) => total + (r.montoTotal || 0), 0),
  ...
  return (
    <>
      ...
      <div style={styles.container}>
        <h2 style={styles.title}>📊 Reportes de Gestión</h2>
        ...
        <div style={styles.statsGrid}>
          ...
          <div className="card" style={{ ...styles.statCard, borderTop: '4px solid #9f7aea' }}>
            <span style={styles.statNumber}>{estadisticas.ocupacion}%</span>
